...
class UpcomingList {
    ...
    public UpcomingList(String contestCode, String contestName, String startDate, String endDate, int contestSourceImg , String imageUrl, String AIC, String contestSource) {
